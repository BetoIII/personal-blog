...
const badgeVariants = cva(
  "inline-flex items-center border-2 px-3 py-1 text-xs font-medium uppercase tracking-wider transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        default:
